    ...
    <div className={styles.root}>
      ...
      <div className={styles.MyExcitel}>
        <div className={styles.OtherTexts}>
          ...
          <h4 className={styles.UI}>UI/UX, fintech, web, android</h4>
          <p className={styles.design}>
            Design an app that enables internet customers to do quick online
            payments, do step-by-step DIY troubleshooting, easily report an
            issue and track progress and save money by finding a better deal.
          </p>
          <h2 className={styles.K}>1M+</h2>
          <h3 className={styles.people}>Downloads in Google Play Store</h3>
        </div>
      ...
      <div className={styles.flesh}>
        ...
        <p className={styles.designcrafter}>
          Designcrafter works in two-week intensives called Product Run at a
          fixed fee. In week one we choose a direction and create key screens.
          In week two we expand and polish.
        </p>
      </div>
    </div>
  )
